...
<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url({{ asset('assets/img/background.png')}})">
    ...
    <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
        ...
        <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            <!--begin::Form-->
            <form method="POST" class="form w-100" id="kt_sign_in_form" action="{{ url('/absen') }}">
                @csrf
                <!--begin::Heading-->
                <div class="text-center mb-10">
                    ...
                    <!--end::Link-->
                    <!--begin::Title-->
                    <h1 class="text-dark mb-3">Absen Radir {{$data['date']}}</h1>
                    <!--end::Title-->
                </div>
                <!--begin::Heading-->
                <!--begin::Input group-->
        ...
        <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
            ...
            <div class="text-center mb-10">
                ...
                <h1 class="text-dark mb-3">Terima kasih sudah absen hari ini {{$data['peserta_absen']}}.</h1>
                @elseif ($data['status_absen'] == 2)
                <h1 class="text-dark mb-3">Absen tidak berhasil, mohon kontak admin radir.</h1>
                @elseif ($data['status_absen'] == 3)
                <h1 class="text-dark mb-3">NIK TG anda belum terdaftar, mohon kontak admin radir untuk mendaftarkan NIK TG anda.</h1>
                @endif
            </div>
            <!--begin::Heading-->
        </div>
