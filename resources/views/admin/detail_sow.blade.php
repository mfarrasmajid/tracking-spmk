...
@section('title', 'Detail SOW')

@section('menu', 'Detail SOW')

@section('sub_menu', 'Detail SOW')
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">@if (isset($data['id'])) Edit SOW @else Add SOW @endif</h3>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <form 
                @if (isset($data['id'])) 
                action="{{ url('/admin/detail_sow') }}/{{$data['id']}}" 
                @else 
                action="{{ url('/admin/detail_sow') }}" 
                @endif 
                ...
                <div class="col-lg-12">
                    <div class="mb-5">
                        ...
                        <input type="text" required class="form-control form-control-solid" name="sow" @if (isset($data['id'])) value="{{ $data['u']->sow }}" @endif>
                    </div>
                </div>
                <div class="text-end">
                    <a href="{{ url('/admin/manage_sow')}}" class="btn btn-sm btn-secondary me-5">Back</a>
