...
@section('title', 'Manage SOW')

@section('menu', 'Manage SOW')

@section('sub_menu', 'Manage SOW')
...
<div class="card card-custom" id="manage_table">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Manage SOW</h3>
        </div>
        <div class="card-toolbar">
            <a href="{{ url('/admin/detail_sow')}}" class="btn btn-sm btn-primary">
                Add SOW
            </a>
        </div>
    </div>
                ...
                <table class="table table-rounded table-striped border gy-5 gs-5" id="datatable">
                    <thead>
                        <tr>
                            ...
                            <th style="min-width: 80px; font-weight:600;">SOW</th>
...
<script>
    ...
    var initTable = function initTable() {
      ...
      var datatable = table.DataTable({
        ...
        ajax: {
          url: "{{ url('/')}}/admin/api/get_list_manage_sow",
          data: {
        ...
        if ($(this).hasClass('btn-delete')){
          $.confirm({
              title: 'Konfirmasi Delete SOW',
              content: 'Apakah anda yakin akan menghapus sow ini?',
              type: 'red',
              typeAnimated: true,
              buttons: {
                  ya: {
      ...
      var PageInfo = $('#datatable').DataTable().page.info();
          ...
          datatable.column(-1, { page: 'current' }).nodes().each( function (cell, i) {
              cell.innerHTML = '<div style="white-space:nowrap">\
                              <a href="{{ url("admin/detail_sow") }}/'+ cell.innerHTML + '" class="btn btn-sm btn-secondary me-2 px-5 py-2 my-1" title="Edit SOW">\
                                Edit SOW\
                              </a>\
