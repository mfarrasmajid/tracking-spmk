...
@section('title', 'Upload SPMK')

@section('menu', 'Upload SPMK')

@section('sub_menu', 'Bulk Upload SPMK')
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Bulk Upload SPMK</h3>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="row">
            <form 
                action="{{ url('/admin/upload_spmk') }}" 
                enctype="multipart/form-data" 
                method="POST">
                @csrf
                <div class="col-lg-12">
                    <div class="mb-5">
                        <label for="excel" class="form-label">Upload List Site Bulk</label>
                        <input type="file" required class="form-control mb-3" name="excel">
                        <a href="{{ asset('/assets')}}/template_bulk_spmk.xlsx" class="fs-7 mb-5">Download template disini</a>
                    </div>
                </div>
                <div class="text-end">
