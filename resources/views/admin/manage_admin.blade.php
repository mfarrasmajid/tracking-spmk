...
@section('menu', 'Manage Admin')

@section('sub_menu', 'Tambahkan atau Edit Admin yang Dapat Akses ke Absensi Radir')
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Manage Admin</h3>
        </div>
        <div class="card-toolbar">
            <!--begin::Button-->
            <a href="{{ url('/admin/add_admin') }}" class="btn btn-danger font-weight-bolder">
		...
		table.DataTable({
			...
			columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return '\
							<a href="{{url("/admin/add_admin/")}}/' + data + '" class="btn btn-sm btn-clean btn-icon" title="Edit">\
            ...
            $.confirm({
                title: 'Delete Admin!',
                content: 'Apakah anda yakin akan menghapus admin ini?',
                type: 'red',
                buttons: {
                    hapus: {
                        text: 'Hapus',
