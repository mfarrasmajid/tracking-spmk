...
@section('menu', 'Download Excel')

@section('sub_menu', 'Absensi Sesuai Jadwal Radir')
...
<div class="card card-custom">
    <div class="card-header">
        <div class="card-title">
            ...
            <h3 class="card-label">Download Excel</h3>
        </div>
    </div>
    <div class="card-body">
        @if (session('error'))
		...
		table.DataTable({
			...
			columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return '\
							<a href="{{url("/admin/download_excel_list/")}}/' + data + '" class="btn btn-sm btn-clean btn-icon" title="Edit">\
